...
for i in query:
    ...
    for j in range(y1, y2):
        rotate.append(rowcolumn[x1][j])

    for j in range(x1, x2):
        rotate.append(rowcolumn[j][y2])

    for j in range(y2, y1, -1):
        rotate.append(rowcolumn[x2][j])

    for j in range(x2, x1, -1):
        rotate.append(rowcolumn[j][y1])
    ...
    for j in range(y1 + 1, y2):
        rowcolumn[x1][j] = rotate.pop(0)

    for j in range(x1, x2):
        rowcolumn[j][y2] = rotate.pop(0)

    for j in range(y2, y1, -1):
        rowcolumn[x2][j] = rotate.pop(0)

    for j in range(x2, x1 - 1, -1):
        rowcolumn[j][y1] = rotate.pop(0)
